"""home_free_21795 URL Configuration
...
admin.site.site_header = "Home Free"
admin.site.site_title = "Home Free Admin Portal"
admin.site.index_title = "Home Free Admin"

# swagger
api_info = openapi.Info(
    title="Home Free API",
    default_version="v1",
    description="API documentation for Home Free App",
)
